...
Note that the tickets generated by this function become invalid once them the process that created them dies. If you are creating tickets in some temporary process, make sure that it stays alive until authentication is over!
