...
* The tickets generated by the `greenworks.getAuthSessionTicket` become invalid once the process that created them dies. If you are creating a new process to do Greenworks things, make sure that it stays alive until authentication is over!
