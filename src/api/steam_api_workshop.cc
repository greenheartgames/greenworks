  ...
  namespace api
  {
    namespace
    {
      ...
      NAN_METHOD(UGCVote)
      {
          ...
          bool vote_up = Nan::To<bool>(info[1]).FromJust();
          ...
          Nan::AsyncQueueWorker(new greenworks::VotePublishedFileWorker(
              success_callback, error_callback, subscribed_file_id, vote_up));
          info.GetReturnValue().Set(Nan::Undefined());
      }
